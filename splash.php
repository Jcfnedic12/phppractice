...
<head>
    ...
    <link rel="stylesheet" href="cssfolderforpdoaral\splash.css">
...
<body>
    <header class="headerist">
        ...
        <div class="splashlist">
            ...
            <ul>
                <li class="list1"><a href="index.php"><span>I</span>ndex</a></li>
                <li class="list2"><a href="signup.php"><span>s</span>ignup</a></li>
                <li class="list3"><a href="login.php"><span>l</span>ogin</a></li>
                <li class="list4"><a href="splash.php"><span>s</span>plashscreen</a></li>
            </ul>
        </div>
    </header>
    ...
    <section class="splashscreen">
        ...
        <div class="rightside">
            <h1><span>Learn</span> to code <br> for <span>free.</span></h1>
            <br>
